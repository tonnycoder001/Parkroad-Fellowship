    ...
    <form action="{{ route('register') }}" method="post" class="space-y-4">
        ...
        <div class="flex flex-col">
            ...
            <input type="text" id="application_date" name="application_date"
                ...
                class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('application_date') }}"
        ...
        <div class="flex flex-col">
            ...
            <input type="text" id="membership_applied_for" name="membership_applied_for"
                class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('membership_applied_for') }}"
                placeholder="membership_applied_for">
        ...
        <div class="flex flex-col">
            ...
            <input type="text" id="first_name" name="first_name"
                class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg " value="{{ old('first_name') }}"
        ...
        <div class="flex flex-col">
            ...
            <input type="text" id="last_name" name="last_name"
                class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg " value="{{ old('last_name') }}"
        ...
        <div class="flex flex-col">
            ...
            <input type="postal_address" id="postal_address" name="postal_address"
                class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('postal_address') }}"
        ...
        <div class="flex flex-col">
            ...
            <input type="email" id="email" name="email"
                class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
                class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('email') }}" placeholder="Email">
